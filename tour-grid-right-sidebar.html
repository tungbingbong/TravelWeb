...
<html lang="en">
    <head>
        <title>Tour Grid Right Sidebar</title>
        <meta charset="utf-8">
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="myNavbar1">
                    <ul class="nav navbar-nav navbar-right navbar-search-link">
                        ...
                        <li class="dropdown active"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Tours<span><i class="fa fa-angle-down"></i></span></a>
                            <ul class="dropdown-menu">
                            	<li><a href="tour-homepage.html">Tour Homepage</a></li>
                                ...
                                <li class="active"><a href="#">Grid View Right Sidebar</a></li>
            ...
            <div id="mySidenav" class="sidenav" >
                ...
                <div id="main-menu">
                    ...
                    <div class="list-group panel">
                        ...
                        <a href="#tours-links" class="list-group-item active" data-toggle="collapse" data-parent="#main-menu"><span><i class="fa fa-globe link-icon"></i></span>Tours<span><i class="fa fa-chevron-down arrow"></i></span></a>
                        <div class="collapse sub-menu" id="tours-links">
                            ...
                            <a href="#" class="list-group-item active">Grid View Right Sidebar</a>
        ...
        <section class="page-cover" id="cover-tour-grid-list">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                    	<h1 class="page-title">Tour Grid Right Sidebar</h1>
                        <ul class="breadcrumb">
                            <li><a href="#">Home</a></li>
                            <li class="active">Tour Grid Right Sidebar</li>
                        </ul>
                    </div><!-- end columns -->
                </div><!-- end row -->
            </div><!-- end container -->
                                    ...
                                    <div class="grid-block main-block t-grid-block">
                                    	<div class="main-img t-grid-img">
                                         ...
                                         <div class="block-info t-grid-info">
                                         	...
                                         	<h3 class="block-title"><a href="tour-detail-right-sidebar.html">Orlando</a></h3>
                                            ...
                                            <div class="grid-btn">
                                            	<a href="tour-detail-right-sidebar.html" class="btn btn-orange btn-block btn-lg">View More</a>
                                            </div><!-- end grid-btn -->
                                         </div><!-- end t-grid-info -->
                                    ...
                                    <div class="grid-block main-block t-grid-block">
                                    	<div class="main-img t-grid-img">
                                         ...
                                         <div class="block-info t-grid-info">
                                         	...
                                         	<h3 class="block-title"><a href="tour-detail-right-sidebar.html">London</a></h3>
                                            <p class="block-minor">2 Adults, 02 Kids</p>
                                            <p>Lorem ipsum dolor sit amet, ad duo fugit aeque fabulas, in lucilius prodesset pri. Veniam delectus ei </p>
                                            <div class="grid-btn">
                                            	<a href="tour-detail-right-sidebar.html" class="btn btn-orange btn-block btn-lg">View More</a>
                                    ...
                                    <div class="grid-block main-block t-grid-block">
                                    	<div class="main-img t-grid-img">
                                         ...
                                         <div class="block-info t-grid-info">
                                         	...
                                         	<h3 class="block-title"><a href="tour-detail-right-sidebar.html">Australia</a></h3>
                                            <p class="block-minor">2 Adults, 02 Kids</p>
                                            <p>Lorem ipsum dolor sit amet, ad duo fugit aeque fabulas, in lucilius prodesset pri. Veniam delectus ei </p>
                                            <div class="grid-btn">
                                            	<a href="tour-detail-right-sidebar.html" class="btn btn-orange btn-block btn-lg">View More</a>
                                    ...
                                    <div class="grid-block main-block t-grid-block">
                                    	<div class="main-img t-grid-img">
                                         ...
                                         <div class="block-info t-grid-info">
                                         	...
                                         	<h3 class="block-title"><a href="tour-detail-right-sidebar.html">Bangkok</a></h3>
                                            <p class="block-minor">2 Adults, 02 Kids</p>
                                            <p>Lorem ipsum dolor sit amet, ad duo fugit aeque fabulas, in lucilius prodesset pri. Veniam delectus ei </p>
                                            <div class="grid-btn">
                                            	<a href="tour-detail-right-sidebar.html" class="btn btn-orange btn-block btn-lg">View More</a>
                                    ...
                                    <div class="grid-block main-block t-grid-block">
                                    	<div class="main-img t-grid-img">
                                         ...
                                         <div class="block-info t-grid-info">
                                         	...
                                         	<h3 class="block-title"><a href="tour-detail-right-sidebar.html">Newzeland</a></h3>
                                            <p class="block-minor">2 Adults, 02 Kids</p>
                                            <p>Lorem ipsum dolor sit amet, ad duo fugit aeque fabulas, in lucilius prodesset pri. Veniam delectus ei </p>
                                            <div class="grid-btn">
                                            	<a href="tour-detail-right-sidebar.html" class="btn btn-orange btn-block btn-lg">View More</a>
                                    ...
                                    <div class="grid-block main-block t-grid-block">
                                    	<div class="main-img t-grid-img">
                                         ...
                                         <div class="block-info t-grid-info">
                                         	...
                                         	<h3 class="block-title"><a href="tour-detail-right-sidebar.html">Shanghai</a></h3>
                                            <p class="block-minor">2 Adults, 02 Kids</p>
                                            <p>Lorem ipsum dolor sit amet, ad duo fugit aeque fabulas, in lucilius prodesset pri. Veniam delectus ei </p>
                                            <div class="grid-btn">
                                            	<a href="tour-detail-right-sidebar.html" class="btn btn-orange btn-block btn-lg">View More</a>
