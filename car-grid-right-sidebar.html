            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <ul class="breadcrumb">
                            <li><a href="#">Home</a></li>
                            <li class="active">Car Grid Right Sidebar</li>
                        </ul>
                    </div><!-- end columns -->
                </div><!-- end row -->
            </div><!-- end container -->
                                    ...
                                    <div class="grid-block main-block cr-grid-block">
                                    	<div class="main-img cr-grid-img">
                                         ...
                                         <div class="block-info cr-grid-info">
                                            ...
                                            <div class="grid-btn">
                                            	<a href="car-detail-right-sidebar.html" class="btn btn-orange btn-block btn-lg">View More</a>
                                            </div><!-- end grid-btn -->
                                    ...
                                    <div class="grid-block main-block cr-grid-block">
                                    	<div class="main-img cr-grid-img">
                                         ...
                                         <div class="block-info cr-grid-info">
                                         	...
                                         	<h3 class="block-title"><a href="car-detail-right-sidebar.html">Iconic</a></h3>
